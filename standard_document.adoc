...
:titletext: Emission Event Modeling Language (EmissionML)
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|Internal reference number of this OGC(R) document:    25-019
|Version: n.n
|Category: OGC(R) Implementation Standar
|Editor:   Steve Liang
|===
...
[width = "50%", grid = "none"]
|===
|Document type:   	OGC® Standard Specification
